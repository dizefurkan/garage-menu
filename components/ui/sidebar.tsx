      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex flex-row w-full min-h-svh has-[[data-variant=inset]]:bg-sidebar",
              className
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative flex-shrink-0 bg-transparent transition-[width] duration-200 ease-linear",
...
>(({ className, style, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex flex-1 flex-col bg-background overflow-hidden min-h-svh",
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow",
        "md:peer-data-[variant=sidebar]:ml-0",
        className
      )}
      style={
        {
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-9 shrink-0 items-center rounded-md px-3 text-sm font-semibold text-sidebar-foreground/80 outline-none ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-5 [&>svg]:shrink-0",
...
>(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    data-sidebar="menu"
    className={cn("flex w-full min-w-0 flex-col gap-2 py-4", className)}
    {...props}
  />
));
    ...
    const button = (
      <Comp
        ...
        onClick={(event) => {
          ...
          if (!event.defaultPrevented && closeOnClick && isMobile) {
            setOpenMobile(false);
          }
        }}
        {...props}
